    ...
    <div className='container mx-auto px-4 py-8'>
      <div className='mb-8'>
        ...
        <p className='text-gray-600'>
          Manage your protected domains and their configurations
        </p>
        <div className='mt-4 rounded-md border border-yellow-200 bg-yellow-50 p-4 text-yellow-800'>
          <div className='flex items-start'>
            <AlertCircle className='h-5 w-5 mr-2 mt-0.5 text-yellow-600' />
            <p className='text-sm'>
              Please add a CNAME record in your DNS settings pointing your
              public domain to <strong>waf.waf-project.kro.kr</strong>.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-500'>
                      ...
                      <strong>{selectedDomain.domain}</strong>? This action
                      cannot be undone.
                    </p>
                  </div>
                </div>
